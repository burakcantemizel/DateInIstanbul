...
function hairButtonsPressed(x,y,button,istouch)
  hairButton0:mousepressed(x,y,button,istouch)
  hairButton1:mousepressed(x, y, button, istouch)
  hairButton2:mousepressed(x, y, button, istouch)
  hairButton3:mousepressed(x, y, button, istouch)
  hairButton4:mousepressed(x, y, button, istouch)
  hairButton5:mousepressed(x, y, button, istouch)
end
